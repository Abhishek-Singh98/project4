...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { city: @trainer.city, description: @trainer.description, email: @trainer.email, experience: @trainer.experience, fees: @trainer.fees, name: @trainer.name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { city: @trainer.city, description: @trainer.description, email: @trainer.email, experience: @trainer.experience, fees: @trainer.fees, name: @trainer.name } }
