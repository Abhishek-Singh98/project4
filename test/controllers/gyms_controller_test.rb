...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { city: @gym.city, contact: @gym.contact, description: @gym.description, email: @gym.email, fees: @gym.fees, name: @gym.name, owner_name: @gym.owner_name } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { city: @gym.city, contact: @gym.contact, description: @gym.description, email: @gym.email, fees: @gym.fees, name: @gym.name, owner_name: @gym.owner_name } }
