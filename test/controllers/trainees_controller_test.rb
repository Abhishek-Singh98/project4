...
class TraineesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainee" do
    assert_difference('Trainee.count') do
      post trainees_url, params: { trainee: { city: @trainee.city, contact: @trainee.contact, description: @trainee.description, email: @trainee.email, name: @trainee.name } }
    end
  ...
  test "should update trainee" do
    patch trainee_url(@trainee), params: { trainee: { city: @trainee.city, contact: @trainee.contact, description: @trainee.description, email: @trainee.email, name: @trainee.name } }
