class GymsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to gyms_url(@gym), notice: "Gym was successfully destroyed." }
  ...
  private
    ...
    def gym_params
      params.require(:gym).permit(:name, :email, :city, :contact, :description, :fees, :owner_name,:password_digest)
    end
end
